...
// console.log(idade)
// alert("Legal! Você tem "+ idade +" anos!")

// const nome = prompt("Qual seu nome?")
// const endereço = prompt("Qual seu endereço?")   
// const idade = prompt("Qual sua idade?")

// console.log("Seu nome é " + nome + ", mora em " + endereço + " e tem " + idade + " anos! Legal!")

// alert("Seu nome é " + nome + ", mora em " + endereço + " e tem " + idade + " anos! Legal!")
